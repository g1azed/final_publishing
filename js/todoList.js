...
const showAllBtnElem = document.querySelector('.show-all-btn'); // all button
const showActiveBtnElem = document.querySelector('.show-active-btn'); //active button
const showCompletedBtnElem = document.querySelector('.show-completed-btn'); //completed button
const clearCompletedBtnElem = document.querySelector('.clear-completed-btn'); // completed clear
